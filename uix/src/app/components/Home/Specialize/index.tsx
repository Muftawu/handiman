            ...
            <div className='container'>
                <div className='text-center mb-8'>
                    ...
                    <p className='text-lg font-normal max-w-2xl mx-auto'>
                        Handiman connects you with reliable experts across technology, construction, electrical works, agriculture, and more — all in one place.
                    </p>
                </div>
                {/*  */}
                        ...
                        : specialization.map((item, i) => (
                            <div key={i}>
                                <div className='bg-secondary dark:bg-darklight rounded-lg p-8'>
                                    <div className='rounded-lg w-fit mb-8 shadow-lg shadow-primary/30'>
                                        <Image
                                            src={item.imgSrc}
                                            alt={item.title}
                                            width={200}
